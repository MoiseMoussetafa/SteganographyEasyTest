    ...
    , ui(new Ui::MainWindow)
{
    ...
    // Connect the "clicked" signal of the pushButton to the "clicked_pushButton" slot
    connect(ui->pushButton, &QPushButton::clicked, this, &MainWindow::clicked_pushButton);
}
...
void MainWindow::clicked_pushButton()
{
